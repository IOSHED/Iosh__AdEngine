...
COMMENT ON COLUMN countries.region IS 'Possible values: Europe, Africa, Oceania, Asia, Unknown';
...
CREATE TABLE IF NOT EXISTS users_profile (
    ...
    interests VARCHAR(64)[] DEFAULT ARRAY[]::VARCHAR(64)[] NOT NULL,
    country_code_id INT NOT NULL REFERENCES countries(id) ON DELETE CASCADE,
